...
root.after(55000,lambda:animate_text1(label_web,"https://sportadvice-en.decathlon.com.hk/all-sports-advices"))
label_web.bind("<Button-1>",lambda event:webbrowser("https://sportadvice-en.decathlon.com.hk/all-sports-advices"))
