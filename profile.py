...
Label(root,text=sys.argv[1],bg="light blue",font=("Arial", 23, "bold")).place(x=560,y=51)
Label(root,text=sys.argv[2],bg="light blue",font=("Arial", 23, "bold")).place(x=560,y=124)
Label(root,text=sys.argv[3],bg="light blue",font=("Arial", 23, "bold")).place(x=560,y=197)
Label(root,text=sys.argv[4],bg="light blue",font=("Arial", 23, "bold")).place(x=470,y=270)
Label(root,text=sys.argv[5],bg="light blue",font=("Arial", 23, "bold")).place(x=515,y=343)
Label(root,text=f"{sys.argv[6]}Kg",bg="light blue",font=("Arial", 23, "bold")).place(x=515,y=416)
Label(root,text=f"{sys.argv[7]}Cm",bg="light blue",font=("Arial", 23, "bold")).place(x=515,y=489)
Label(root,text=sys.argv[8],bg="light blue",font=("Arial", 23, "bold")).place(x=510,y=562)
root.mainloop()
